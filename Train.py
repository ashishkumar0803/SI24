...
def main():
    ...
    dataPreprocess_bert(r"C:/Users/91993/Downloads/dse/Summer Internship 2024 (IISERB)/github/Malicious-URL-Detection-PMANet/Data/Kaggle_binary_dataset/kaggle_binary.csv", input_ids, input_types, input_masks, label, 0)
    dataPreprocess_bert(r"C:/Users/91993/Downloads/dse/Summer Internship 2024 (IISERB)/github/Malicious-URL-Detection-PMANet/Data/Kaggle_binary_dataset/kaggle_binary.csv", input_ids, input_types, input_masks, label, 1)
    ...
    best_acc = 0.0
    NUM_EPOCHS = 3
    PATH = r'C:/Users/91993/Downloads/dse/Summer Internship 2024 (IISERB)/github/Malicious-URL-Detection-PMANet/charbert-bert-wiki'  # Define the model saving path
